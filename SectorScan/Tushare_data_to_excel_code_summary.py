...
appended_data = []
for dates in list:
    all_data = pro.income_vip(period='20181231',fields='ts_code,ann_date,end_date,report_type,comp_type,total_revenue,total_cogs,oper_cost,operate_profit,total_profit,n_income,ebit,ebitda,basic_eps')
